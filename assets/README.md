...
- `nine_squares_al_boardman.json`, `boat_loader.json`, `icon_transitions.json`, `lottie_logo_1.json`, `lottie_logo_1_masked.json`, `switch.json`, `switch_states.json`, `twitter_heart_button.json`, `watermelon.json`, and `success.json` come from `airbnb/lottie-ios` at commit `906e79b0648c16f02ad5844e345481ae05a94afe`.
